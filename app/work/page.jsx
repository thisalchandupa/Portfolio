...
const projects = [
  {
    num: '01',
    category: 'Mern stack',
    title: 'Project Siesta',
    description: 'ECommerce App with Admin Panel : React, Redux Toolkit, Tailwind, MongoDB',
    stack: [{ name: "Html5" }, { name: "Tailwind CSS" }, { name: "MongoDB" },],
    image: "/Siesta.jpg",
    live: "",
    github: "",
  },

  {
    ...
    category: 'Mern stack',
    title: 'Tasty',
    description: 'Complete Food Delivery App Using React JS',
    stack: [{ name: "Html5" }, { name: "Vite" }, { name: "CSS" },],
    image: "/Tasty.jpg",
    live: "",
    github: "",
  },

  {
    ...
    category: 'Mern stack ',
    title: 'ABC labs',
    description: 'Modern Lab system with Next.js + Admin dashboard',
    stack: [{ name: "Html5" }, { name: "Tailwind CSS" }, { name: "NextJS" },],
    image: "/abc.jpg",
    live: "",
    github: "",
  },
